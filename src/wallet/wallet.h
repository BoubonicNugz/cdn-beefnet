...
public:
    ...
    // Canada eCoin: SegWit removed the coinbase merkle tree and only included it for
    // Canada eCoin: backwards compatibility with older bitcoin clients.
    // Canada eCoin: Canada eCoin still needs it here
