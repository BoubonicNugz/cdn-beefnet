...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"beefnetaddress\"\n"
            "\nReveals the private key corresponding to 'beefnetaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"beefnetaddress\"   (string, required) The viacoin address for the private key\n"
            "\nResult:\n"
