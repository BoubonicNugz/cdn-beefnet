...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"beefnetaddress\"\n"
            "\nReturn information about the given viacoin address.\n"
            "\nArguments:\n"
            "1. \"beefnetaddress\"     (string, required) The viacoin address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"beefnetaddress\", (string) The viacoin address validated\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"beefnetaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"beefnetaddress\"  (string, required) The viacoin address to use for the signature.\n"
