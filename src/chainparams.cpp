...
{
    const char* pszTimestamp = "CBC.CA 28/Oct/2018 Farm-share arrangement splits risky business with local farmers";
    const CScript genesisOutputScript = CScript() << ParseHex("04259B26267095AD0B939915809B65EFDBAC13BB6713C6E4A6D5B9B7948501C7852910A0F158DFD7449DB773D646150658C239930807C66C70263533AB3E1CCEE9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0x42bf13d181b65f9b74c0fa83303c6cb84242bebe9b667ff116ebb24014a26fef");
        ...
        consensus.nPowTargetSpacing = 1 * 180;  // Beefnet, 3 minutes...
        ...
        consensus.nCLTVStartBlock = 100;
        consensus.nBIP66MinStartBlock = 100;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 1530230400; // changed to June 28, 2018
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 1530230500;   // June 28, 2018+100

        // Deployment of SegWit (BIP141, BIP143, and BIP147)
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = 1530230400; // changed to June 28, 2018
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 1530230500;   // June 28, 2018+100

        // The best chain should have at least this much work.
        // -- stripped
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000");
        ...
        genesis = CreateGenesisBlock(1509297898, 240004, 0x1e0ffff0, 1, 1 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x42bf13d181b65f9b74c0fa83303c6cb84242bebe9b667ff116ebb24014a26fef"));
        assert(genesis.hashMerkleRoot == uint256S("0x6eb9023069b9be4cc43da758ad97da838225c1e36e4c26438baa7a65c66f4e68"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        // TODO - LED - Check which viacoin nodes support service bits and add the 'true' flag
        //vSeeds.push_back(CDNSSeedData("canadaecoin.net", "69.196.165.88"));
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x1E)(0x56)(0x2D)(0x9A).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x1E)(0x56)(0x31)(0xBC).convert_to_container<std::vector<unsigned char> >();
    ...
    checkpointData = (CCheckpointData) {
        boost::assign::map_list_of
            ( 0, uint256S("0x42bf13d181b65f9b74c0fa83303c6cb84242bebe9b667ff116ebb24014a26fef")),
            1509309504, // * UNIX timestamp of last checkpoint block
