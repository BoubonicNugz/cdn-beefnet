...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s beefnet-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  beefnet-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded beefnet transaction") + "\n" +
              "  beefnet-tx [options] -create [commands]   " + _("Create hex-encoded beefnet transaction") + "\n" +
              "\n";
