Contributing to CDN Beefnet
============================

The CDN Beefnet project operates an open contributor model where anyone is welcome to contribute towards development in the form of peer review, testing and patches. This document explains the practical process and guidelines for contributing.
...
The following applies to code changes to the CDN Beefnet project (and related projects such as libsecp256k1), and is not to be confused with overall Canada eCoin Network Protocol consensus changes.

Whether a pull request is merged into CDN Beefnet rests with the project merge maintainers and ultimately the project lead.
...
The project leader is the release manager for each CDN Beefnet release.
